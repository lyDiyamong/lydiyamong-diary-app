    ...
    notesData.forEach((item, id) => {
        ...
        <div id=${id} class="diary-note">
            <div class="note-header">
                ...
                <div>
                    <img class="view-btn" data-id="${id}" src="/src/images/icons/View.svg" alt="">
                    <img class="edit-btn" data-id="${id}" src="/src/images/icons/Edit.svg" alt="">
                    <img class="delete-btn" data-id="${id}" src="/src/images/icons/Delete.svg" alt="">
                </div>
            </div>
